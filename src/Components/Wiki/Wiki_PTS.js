        ...
        <div className={classes.Wiki}>
          ...
          <ul>
            ...
            <ul>
              ...
              <li>
                {/* If the member stay at the home, a warning will appear. Click on
                'Ok' or 'Yes' if this member is last member of family, this will
                end the survey. Else click on 'Cancel' or 'No', this will send
                you to the trip page.{" "}
                <span
                  className={classes.ImageLink}
                  onClick={() => this.onClickHandler(MemberScreenshot4)}
                >
                  See an example.
                </span> */}
              </li>
