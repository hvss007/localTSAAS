  ...
  return (
    <div>
      <Card raised className={classes.root}>
        ...
        <RatingStars ratingQuestion="Convenience and ease to acces the interchange" />
        <RatingStars ratingQuestion="Availability of fix Pick and drop places for different modes" />
        ...
        <RatingStars ratingQuestion="Availability of total number of seats inside the travel modes nad waiting areas" />
        <RatingStars ratingQuestion="Availability of Wi-Fi, mobilephone and internet signals" />
        <RatingStars ratingQuestion="Availability of total number of charging points inside the travel modes and waiting areas" />
        <RatingStars ratingQuestion="Facilities provided for infants, children nad pregnant women" />
        ...
        <RatingStars ratingQuestion="Presence of amount of dustbins (seperate for wet and dry waste)" />
        ...
        <RatingStars ratingQuestion="Overall rating of Anand Vihar as a multimodal transport hub" />
