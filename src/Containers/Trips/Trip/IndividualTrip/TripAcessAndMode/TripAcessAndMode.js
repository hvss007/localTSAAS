    ...
    render(){
        ...
        return(
            <Aux>
                ...
                <p style={{textAlign:'justify'}}> <b>Note:</b> Please add all travel modes in the order which the member uses them. Starting and ending with <span><img alt="walk" style={{width:'30px'}} src={Walk}></img></span> (walk).</p>
